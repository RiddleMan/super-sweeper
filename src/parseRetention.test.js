...
test("should return a date 1 day back", () => {
    ...
    expect(actual.getTime()).toBe(new Date(2019, 7, 31).getTime());
});
...
test("should return a date 1 hour back", () => {
    ...
    expect(actual.getTime()).toBe(new Date(2019, 8, 1, 1).getTime());
});
...
test("should return a date 2 hours back", () => {
    ...
    expect(actual.getTime()).toBe(new Date(2019, 8, 1, 0).getTime());
});
...
test("should return a date 2 years back", () => {
    ...
    expect(actual.getTime()).toBe(new Date(2017, 1, 1).getTime());
});
...
test("should return a date 10 minutes back", () => {
    ...
    expect(actual.getTime()).toBe(new Date(2019, 1, 1, 0, 34).getTime());
});
...
test("should return a date 3 months back", () => {
    ...
    expect(actual.getTime()).toBe(new Date(2019, 5, 3).getTime());
});
...
test("should return a date 600s back", () => {
    ...
    expect(actual.getTime()).toBe(new Date(2019, 8, 1, 0, 50).getTime());
});
