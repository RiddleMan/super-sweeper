...
describe("clean()", () => {
    test("should call removeFiles with those provided by matchFiles", async () => {
        ...
        expect(removeFiles).toBeCalledWith(expectedFiles);
    });
    ...
    test("should not call removeFiles when dry mode is enabled", async () => {
        ...
        expect(removeFiles).not.toBeCalled();
    });
    ...
    test("should call matchFiles with path, match, and retention", async () => {
        ...
        expect(matchFiles).toBeCalledWith(expectedPathDef);
    });
    ...
    test("should expand user home directory", async () => {
        ...
        expect(matchFiles).toBeCalledWith({
    ...
    test("should call matchFiles 3 times", async () => {
        ...
        expect(matchFiles).toBeCalledWith(expectedPathDef1);
        expect(matchFiles).toBeCalledWith(expectedPathDef2);
        expect(matchFiles).toBeCalledWith(expectedPathDef3);
    });
